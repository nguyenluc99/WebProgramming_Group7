...
#define CONFIGURE_ARGS " '--prefix=/home/viet/Project/WebProgramming_Group7/postgresql-14.0/library' '--enable-cassert' '--enable-debug' 'CFLAGS=-O0 -g -fno-omit-frame-pointer'"
...
#define PG_VERSION_STR "PostgreSQL 14.0 on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 11.2.0-19ubuntu1) 11.2.0, 64-bit"
