...
#define CONFIGURE_ARGS " '--prefix=/Users/macbook/workspace/20212/webProgramming/WebProgramming_Group7/postgresql-14.0/library' '--enable-cassert' '--enable-debug' 'CFLAGS=-O0 -g -fno-omit-frame-pointer'"
...
#define PG_VERSION_STR "PostgreSQL 14.0 on x86_64-apple-darwin18.7.0, compiled by Apple LLVM version 10.0.1 (clang-1001.0.46.4), 64-bit"
